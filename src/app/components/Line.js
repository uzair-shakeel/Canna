...
const Line = () => {
  ...
  const repeatedItems2 = repeatedItems.concat(items); // Repeat the items to create a seamless scroll
  const repeatedItems3 = repeatedItems2.concat(items); // Repeat the items to create a seamless scroll

  return (
    <div className="carousel-container bg-blue-100 flex items-center py-2 text-sm overflow-hidden">
      <div className="carousel-content">
        {repeatedItems3.map((item, index) => (
