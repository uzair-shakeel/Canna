  ...
  return (
    <div className="py-24 px-[10%] grid grid-cols-3 gap-[5%]">
      <div className="relative rounded-full border shadow-2xl border-black p-6 overflow-hidden bg-black/10">
        ...
        <p className="font-extrabold text-black  border-black border-[1px] md:border-[2px] bg-white/50 backdrop-blur-sm w-full text-center py-1 md:py-3 absolute bottom-0 md:-bottom-2 lg:bottom-2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[8px] md:text-md lg:text-2xl ">
          Delivery
        </p>
      </div>
      <div className="relative rounded-full border shadow-2xl border-black p-6 overflow-hidden bg-black/10">
